...
/// <param name='boulder_node'> - double pointer will point to address of boulder_node if collision occurred</param>
/// <param name='bullet_node'> - double pointer will point to address of bullet_node if collision occurred</param>
