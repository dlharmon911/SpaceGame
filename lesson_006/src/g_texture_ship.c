...
static const ALLEGRO_COLOR G_COLOR_SHIP_OUTLINE = { 1.0f, 0.5f, 1.0f, 1.0f };
...
static const float G_SHIP_CIRCLE_RADIUS = { 0.04f };
...
int32_t g_texture_generate_ship_texture(ALLEGRO_BITMAP** bitmap)
{
	...
	*bitmap = al_create_bitmap((int32_t)G_SHIP_SIZE.m_x, (int32_t)G_SHIP_SIZE.m_y);
	...
	al_draw_line(x + cx, y + 0.0f, x + 0.0f, y + cy, G_COLOR_SHIP_OUTLINE, 1.0f);
	al_draw_line(x + cx, y + 0.0f, x + w - 1.0f, y + cy, G_COLOR_SHIP_OUTLINE, 1.0f);
	al_draw_line(x + cx, y + h - 1.0f, x + 0.0f, y + cy, G_COLOR_SHIP_OUTLINE, 1.0f);
	al_draw_line(x + cx, y + h - 1.0f, x + w - 1.0f, y + cy, G_COLOR_SHIP_OUTLINE, 1.0f);
