...
{
	if (s_input_was_keyboard_button_released(g_data.m_input_data, ALLEGRO_KEY_ESCAPE))
	{
		g_data.m_is_running = false;
		s_input_acknowledge_keyboard_button(g_data.m_input_data, ALLEGRO_KEY_ESCAPE);
	}
}
