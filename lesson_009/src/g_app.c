...
int32_t g_app_initialize()
{
	...
	al_flip_display();
	s_point_set_f(&g_data.m_game_data.m_stats.m_display_size,
		(float)al_get_display_width(g_data.m_display),
		(float)al_get_display_height(g_data.m_display));
	s_point_set(&g_data.m_display_scale, &g_data.m_game_data.m_stats.m_display_size);
