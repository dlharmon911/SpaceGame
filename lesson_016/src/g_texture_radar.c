...
{
	al_draw_line(center_x - radius, center_y, center_x + radius, center_y, G_RADAR_COLOR_CROSSHAIR, G_RADAR_LINE_THICKNESS);
	al_draw_line(center_x, center_y - radius, center_x, center_y + radius, G_RADAR_COLOR_CROSSHAIR, G_RADAR_LINE_THICKNESS);
