...
enum G_MODEL_RADAR_MODEL_INDEX
{
	G_MODEL_RADAR_MODEL_BACKGROUND,
	G_MODEL_RADAR_MODEL_CIRCLE,
	G_MODEL_RADAR_MODEL_SWEEP,
	G_MODEL_RADAR_MODEL_ICON_00,
	G_MODEL_RADAR_MODEL_ICON_01,
	G_MODEL_RADAR_MODEL_ICON_02,
	G_MODEL_RADAR_MODEL_ICON_03,
	G_MODEL_RADAR_MODEL_ICON_04,
	G_MODEL_RADAR_MODEL_ICON_05,
	G_MODEL_RADAR_MODEL_ICON_06,
	G_MODEL_RADAR_MODEL_ICON_07,
	G_MODEL_RADAR_MODEL_ICON_08,
	G_MODEL_RADAR_MODEL_ICON_09,
	G_MODEL_RADAR_MODEL_ICON_10,
	G_MODEL_RADAR_MODEL_ICON_11,
	G_MODEL_RADAR_MODEL_ICON_12,
	G_MODEL_RADAR_MODEL_ICON_13,
	G_MODEL_RADAR_MODEL_ICON_14,
	G_MODEL_RADAR_MODEL_ICON_15,
	G_MODEL_RADAR_MODEL_ICON_16,
	G_MODEL_RADAR_MODEL_ICON_17,
	G_MODEL_RADAR_MODEL_ICON_18,
	G_MODEL_RADAR_MODEL_ICON_19,
	G_MODEL_RADAR_MODEL_COUNT,

	G_MODEL_RADAR_MODEL_ICON_START = G_MODEL_RADAR_MODEL_ICON_00,
	G_MODEL_RADAR_MODEL_ICON_END = G_MODEL_RADAR_MODEL_ICON_19,
	G_MODEL_RADAR_MODEL_ICON_COUNT = (1 + G_MODEL_RADAR_MODEL_ICON_END - G_MODEL_RADAR_MODEL_ICON_START)
};

typedef struct g_radar_model_array_t
{
	s_quad_model_t m_model[G_MODEL_RADAR_MODEL_COUNT];
} g_radar_model_array_t;
...
/// <summary>Populate radar model array information</summary>
/// <param name='ship_model'> - data for the model</param>
/// <param name='model'> - data for the spacelib model (pointers)</param>
/// <param name='texture'> - bitmap for the model</param>
/// <returns>n/a</returns>
