...
int32_t g_texture_generate_ship_texture(ALLEGRO_BITMAP** bitmap)
{
	...
	*bitmap = al_create_bitmap((int32_t)G_TEXTURE_SHIP_SIZE.m_x, (int32_t)G_TEXTURE_SHIP_SIZE.m_y);
	...
	al_put_pixel((int32_t)w - 1, 0, al_map_rgb_f(1.0f, 1.0f, 1.0f));
	al_put_pixel((int32_t)w - 1, 1, al_map_rgb_f(1.0f, 1.0f, 1.0f));
	al_put_pixel((int32_t)w - 1, 2, al_map_rgb_f(1.0f, 1.0f, 0.0f));
	al_put_pixel((int32_t)w - 1, 3, al_map_rgb_f(1.0f, 0.5f, 0.0f));
